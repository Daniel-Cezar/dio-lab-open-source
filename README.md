...
> [!NOTE]   
> Por exemplo, a URL https://github.com/Daniel-Cezar/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`Daniel-Cezar`" para a contribuição no repositório `dio-lab-open-source`.
